...
title("luir: Relative Residual vs Matrix Size (condition = 1e2)")
xlabel("Matrix Size")
ylabel("Relative Residual")
saveas(gcf,'luir_acc_lcond.png')
figure(2)
semilogy(sizes, relresgm);
title("gmres: Relative Residual vs Matrix Size (condition = 1e2)")
xlabel("Matrix Size")
ylabel("Relative Residual")
...
title("Iterations vs Matrix Size (condition = 1e2)")
xlabel("Matrix Size")
ylabel("Number of Iterations")
legend("luir", "gmres")
saveas(gcf,'iter_lcond.png')

figure(4)
plot(sizes, timelu, sizes, timegm);
title("Time vs Matrix Size (condition = 1e2)")
xlabel("Matrix Size")
ylabel("Time (seconds)")
legend("luir", "gmres")
saveas(gcf,'time_lcond.png')
